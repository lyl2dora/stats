...
public class SMCHelper {
    ...
    private let id: String = "zone.lyl.stats.SMC.Helper"
    private let plistName: String = "zone.lyl.stats.SMC.Helper.plist"
    ...
    public func checkForUpdate() {
        ...
        let helperURL = Bundle.main.bundleURL.appendingPathComponent("Contents/Library/LaunchServices/zone.lyl.stats.SMC.Helper")
    ...
    private func installLegacy(completion: @escaping (_ state: SMCHelperInstallState) -> Void) {
        ...
        if SMJobBless(kSMDomainSystemLaunchd, "zone.lyl.stats.SMC.Helper" as CFString, authRef, &error) == false {
    ...
    private func helperConnection() -> NSXPCConnection? {
        ...
        let connection = NSXPCConnection(machServiceName: "zone.lyl.stats.SMC.Helper", options: .privileged)
